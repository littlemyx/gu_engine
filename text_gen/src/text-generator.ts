...
Жёсткие правила:
  ...
  4. transitions — РОВНО по одной записи на каждый элемент outgoingTargets.
     ...
     происходят внутри следующего этапа. Без стрелок, без мета-формулировок
...
Жёсткие правила:
  ...
  7а. Выходной choice (nextSceneId = null) — это ЗАВЕРШЕНИЕ разговора: его текст
      ...
      ведёт к следующей сцене, где персонаж отвечает. В последней сцене диалога
      все выборы — только завершающие формулировки.
